...
* [Awesome TypeScript](#ts-logomediats-favicon-96x96png-awesome-typescript)
  ...
  * [TypeScript Real World Design Patterns](https://github.com/vahidvdn/realworld-design-patterns) ⭐ 327 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-15
...
* [Microsoft - TypeScript 2.4 新特性一览](https://github.com/Microsoft/TypeScript/wiki/What's-new-in-TypeScript) ⭐ 111,146 | 🐛 5,003 | 🌐 Go | 📅 2026-09-21
...
* [Microsoft - TypeScript-Handbook](https://github.com/Microsoft/TypeScript-Handbook) ⚠️ Archived
* [TypeStrong - Learn TypeScript](https://github.com/TypeStrong/learn-typescript) ⭐ 708 | 🐛 1 | 🌐 TypeScript | 📅 2022-02-06
...
* [Microsoft - TypeScriptSamples](https://github.com/Microsoft/TypeScriptSamples) ⚠️ Archived
* [Lemoncode - react-typescript-samples](https://github.com/Lemoncode/react-typescript-samples) ⭐ 1,847 | 🐛 5 | 🌐 TypeScript | 📅 2023-04-02
* [DanWahlin - Angular-JumpStart](https://github.com/DanWahlin/Angular-JumpStart) ⭐ 1,588 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-14
* [luixaviles - socket-io-typescript-chat](https://github.com/luixaviles/socket-io-typescript-chat) ⭐ 825 | 🐛 43 | 🌐 TypeScript | 📅 2023-04-22
* [jaysoo - todomvc-redux-react-typescript](https://github.com/jaysoo/todomvc-redux-react-typescript) ⭐ 675 | 🐛 5 | 🌐 TypeScript | 📅 2019-10-31
* [dwyl - hapi-typescript-example](https://github.com/dwyl/hapi-typescript-example) ⭐ 353 | 🐛 3 | 🌐 TypeScript | 📅 2019-05-18
* [chsakell - aspnet5-angular2-typescript](https://github.com/chsakell/aspnet5-angular2-typescript) ⭐ 345 | 🐛 4 | 🌐 C# | 📅 2019-03-25
* [rangle - typescript-react-redux-example](https://github.com/rangle/typescript-react-redux-example)

#### Guide

* [sw-yx - react-typescript-cheatsheet](https://github.com/sw-yx/react-typescript-cheatsheet) ⭐ 47,098 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-09
* [piotrwitek - react-redux-typescript-guide](https://github.com/piotrwitek/react-redux-typescript-guide) ⭐ 13,258 | 🐛 99 | 🌐 TypeScript | 📅 2026-05-09
...
* [brookshi - awesome-typescript-projects](https://github.com/brookshi/awesome-typescript-projects) ⭐ 896 | 🐛 9 | 🌐 TypeScript | 📅 2023-06-13

## TypeScript Starters/Boilerplates

* [Kriasoft - React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,687 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-21
...
* [w3tecch - express-typescript-boilerplate](https://github.com/w3tecch/express-typescript-boilerplate) ⭐ 3,412 | 🐛 97 | 🌐 TypeScript | 📅 2023-05-07
* [jsynowiec - node-typescript-boilerplate](https://github.com/jsynowiec/node-typescript-boilerplate) ⭐ 2,957 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-30
...
* [rokoroku - react-redux-typescript-boilerplate](https://github.com/rokoroku/react-redux-typescript-boilerplate) ⭐ 1,187 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28
* [Marve10s - better-fullstack](https://github.com/Marve10s/Better-Fullstack) ⭐ 748 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - End-to-end fullstack scaffolding across TypeScript, Rust, Python & Go — code ready for you or your AI agent.
...
* [Microsoft - TypeScript-Knockout-Starter](https://github.com/Microsoft/TypeScript-Knockout-Starter) ⚠️ Archived
...
* [torokmark - design\_patterns\_in\_typescript](https://github.com/torokmark/design_patterns_in_typescript) ⭐ 5,432 | 🐛 7 | 🌐 TypeScript | 📅 2023-09-05
...
* [ts-audio](https://github.com/evandrolg/ts-audio) ⭐ 339 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-18

#### webpack

* [TypeStrong - ts-loader](https://github.com/TypeStrong/ts-loader) ⭐ 3,481 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-21
* [s-panferov - awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) ⚠️ Archived

#### gulp

* [ivogabe - gulp-typescript](https://github.com/ivogabe/gulp-typescript) ⭐ 851 | 🐛 62 | 🌐 JavaScript | 📅 2023-02-02

#### grunt

* [TypeStrong - grunt-ts](https://github.com/TypeStrong/grunt-ts) ⭐ 327 | 🐛 81 | 🌐 JavaScript | 📅 2022-12-07

#### compiler

* [AssemblyScript - assemblyscript](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,024 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-14
* [TypeStrong - ts-node](https://github.com/TypeStrong/ts-node) ⭐ 13,120 | 🐛 232 | 🌐 TypeScript | 📅 2024-07-18
* [bcherny - json-schema-to-typescript](https://github.com/bcherny/json-schema-to-typescript) ⭐ 3,348 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-07
* [YousefED - typescript-json-schema](https://github.com/YousefED/typescript-json-schema) ⭐ 3,267 | 🐛 188 | 🌐 TypeScript | 📅 2026-07-14
...
* [palantir - tslint](https://github.com/palantir/tslint) ⚠️ Archived
* [Open Code Review](https://github.com/raye-deng/open-code-review) ⭐ 39 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-16 - AI code quality gate detecting hallucinated packages, phantom dependencies, stale APIs, and AI-specific code defects. MCP Server + CLI + CI/CD.
* [ESLint](https://eslint.org/)

### Ioc

* [Inversify - InversifyJS](https://github.com/inversify/InversifyJS) ⭐ 12,064 | 🐛 2 | 🌐 TypeScript | 📅 2025-11-19
* [Inversify - inversify-express-example](https://github.com/inversify/inversify-express-example) ⚠️ Archived
* [InferDI](https://github.com/inferdi/inferdi) ⭐ 81 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-10 - Type-safe, decorator-free dependency injection container for modern TypeScript with framework adapters.
* [Injex Framework](https://www.injex.dev)
* [Injex Express Plugin](https://www.injex.dev/docs/plugins/express)

### Doc

* [TypeStrong - typedoc](https://github.com/TypeStrong/typedoc) ⭐ 8,452 | 🐛 20 | 🌐 TypeScript | 📅 2026-07-13

### Data Structure

* [dcodeIO - protobuf.js](https://github.com/dcodeIO/protobuf.js) ⭐ 10,594 | 🐛 95 | 🌐 JavaScript | 📅 2026-09-19
* [basarat - typescript-collections](https://github.com/basarat/typescript-collections) ⭐ 1,206 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-12
* [samchon - tstl](https://github.com/samchon/tstl) ⭐ 630 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-22
* [smoren - itertools-ts](https://github.com/Smoren/itertools-ts) ⭐ 92 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-18

### Database

* [Typeorm - typeorm](https://github.com/typeorm/typeorm) ⭐ 36,655 | 🐛 665 | 🌐 TypeScript | 📅 2026-09-21
  * [samchon - safe-typeorm](https://github.com/samchon/safe-typeorm) ⚠️ Archived
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,230 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-21
* [RobinBuschmann - sequelize-typescript](https://github.com/RobinBuschmann/sequelize-typescript) ⭐ 2,836 | 🐛 264 | 🌐 TypeScript | 📅 2024-04-20

### Server

* [kamilmysliwiec - nest](https://github.com/nestjs/nest) ⭐ 76,696 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-21
  * [samchon - nestia](https://github.com/samchon/nestia) ⭐ 2,179 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-16
* [welefen - thinkjs](https://github.com/thinkjs/thinkjs) ⭐ 5,266 | 🐛 145 | 🌐 JavaScript | 📅 2026-08-07
* [samchon - tgrid](https://github.com/samchon/tgrid) ⭐ 167 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-20
* [samchon - mutex-server](https://github.com/samchon/mutex-server) ⭐ 32 | 🐛 3 | 🌐 TypeScript | 📅 2024-06-25
* [Alibaba - egg.js](https://eggjs.org/)

### Utility

* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 3,015 | 🐛 2 | 🌐 Vue | 📅 2026-09-21 - Streaming Markdown renderer for AI chat interfaces, with Vue, React, Svelte, Angular, and Vue 2 packages plus Mermaid, KaTeX, syntax highlighting, safe HTML, and SSR support.
* [csv-pipe](https://github.com/martsinlabs/csv-pipe) ⭐ 14 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-11
...
* [capcut-cli](https://github.com/renezander030/capcut-cli) ⭐ 689 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-20
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 638 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 - Build agent that uses 80% less token and delivers better results.
...
* [TypeScript Syntax for VIM](https://github.com/leafgarland/typescript-vim) ⭐ 1,895 | 🐛 42 | 🌐 Vim Script | 📅 2025-01-15
* [TypeScript Sublime Plugin](https://github.com/Microsoft/TypeScript-Sublime-Plugin) ⭐ 1,703 | 🐛 161 | 🌐 JavaScript | 📅 2026-09-14
* [TypeScript Interactive Development Environment for Emacs](https://github.com/ananthakumaran/tide) ⭐ 1,475 | 🐛 39 | 🌐 Emacs Lisp | 📅 2026-02-19
* [Atom TypeScript](https://github.com/TypeStrong/atom-typescript) ⭐ 1,125 | 🐛 21 | 🌐 TypeScript | 📅 2023-01-01
