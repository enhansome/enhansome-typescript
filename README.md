...
* [Awesome TypeScript](#ts-logomediats-favicon-96x96png-awesome-typescript)
  ...
  * [TypeScript Real World Design Patterns](https://github.com/vahidvdn/realworld-design-patterns) ⭐ 328 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-15
...
* [Microsoft - TypeScript 2.4 新特性一览](https://github.com/Microsoft/TypeScript/wiki/What's-new-in-TypeScript) ⭐ 111,003 | 🐛 5,058 | 🌐 Go | 📅 2026-09-11
...
* [Lemoncode - react-typescript-samples](https://github.com/Lemoncode/react-typescript-samples) ⭐ 1,848 | 🐛 5 | 🌐 TypeScript | 📅 2023-04-02
* [DanWahlin - Angular-JumpStart](https://github.com/DanWahlin/Angular-JumpStart) ⭐ 1,589 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-14
...
* [dwyl - hapi-typescript-example](https://github.com/dwyl/hapi-typescript-example) ⭐ 354 | 🐛 3 | 🌐 TypeScript | 📅 2019-05-18
...
* [sw-yx - react-typescript-cheatsheet](https://github.com/sw-yx/react-typescript-cheatsheet) ⭐ 47,100 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-09
* [piotrwitek - react-redux-typescript-guide](https://github.com/piotrwitek/react-redux-typescript-guide) ⭐ 13,259 | 🐛 99 | 🌐 TypeScript | 📅 2026-05-09
...
* [Kriasoft - React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,676 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07
...
* [w3tecch - express-typescript-boilerplate](https://github.com/w3tecch/express-typescript-boilerplate) ⭐ 3,414 | 🐛 97 | 🌐 TypeScript | 📅 2023-05-07
* [jsynowiec - node-typescript-boilerplate](https://github.com/jsynowiec/node-typescript-boilerplate) ⭐ 2,956 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-30
...
* [rokoroku - react-redux-typescript-boilerplate](https://github.com/rokoroku/react-redux-typescript-boilerplate) ⭐ 1,188 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28
* [Marve10s - better-fullstack](https://github.com/Marve10s/Better-Fullstack) ⭐ 741 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-11 - End-to-end fullstack scaffolding across TypeScript, Rust, Python & Go — code ready for you or your AI agent.
...
* [torokmark - design\_patterns\_in\_typescript](https://github.com/torokmark/design_patterns_in_typescript) ⭐ 5,433 | 🐛 7 | 🌐 TypeScript | 📅 2023-09-05
...
* [TypeStrong - ts-loader](https://github.com/TypeStrong/ts-loader) ⭐ 3,479 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-03
* [s-panferov - awesome-typescript-loader](https://github.com/s-panferov/awesome-typescript-loader) ⚠️ Archived

#### gulp

* [ivogabe - gulp-typescript](https://github.com/ivogabe/gulp-typescript) ⭐ 852 | 🐛 62 | 🌐 JavaScript | 📅 2023-02-02
...
* [AssemblyScript - assemblyscript](https://github.com/AssemblyScript/assemblyscript) ⭐ 18,013 | 🐛 203 | 🌐 WebAssembly | 📅 2026-09-03
* [TypeStrong - ts-node](https://github.com/TypeStrong/ts-node) ⭐ 13,125 | 🐛 232 | 🌐 TypeScript | 📅 2024-07-18
* [bcherny - json-schema-to-typescript](https://github.com/bcherny/json-schema-to-typescript) ⭐ 3,348 | 🐛 139 | 🌐 TypeScript | 📅 2026-09-07
...
* [Open Code Review](https://github.com/raye-deng/open-code-review) ⭐ 37 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-16 - AI code quality gate detecting hallucinated packages, phantom dependencies, stale APIs, and AI-specific code defects. MCP Server + CLI + CI/CD.
* [ESLint](https://eslint.org/)

### Ioc

* [Inversify - InversifyJS](https://github.com/inversify/InversifyJS) ⭐ 12,069 | 🐛 2 | 🌐 TypeScript | 📅 2025-11-19
* [Inversify - inversify-express-example](https://github.com/inversify/inversify-express-example) ⚠️ Archived
* [InferDI](https://github.com/inferdi/inferdi) ⭐ 78 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-10 - Type-safe, decorator-free dependency injection container for modern TypeScript with framework adapters.
* [Injex Framework](https://www.injex.dev)
* [Injex Express Plugin](https://www.injex.dev/docs/plugins/express)

### Doc

* [TypeStrong - typedoc](https://github.com/TypeStrong/typedoc) ⭐ 8,453 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-13

### Data Structure

* [dcodeIO - protobuf.js](https://github.com/dcodeIO/protobuf.js) ⭐ 10,586 | 🐛 88 | 🌐 JavaScript | 📅 2026-09-11
* [basarat - typescript-collections](https://github.com/basarat/typescript-collections) ⭐ 1,206 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-12
* [samchon - tstl](https://github.com/samchon/tstl) ⭐ 631 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-22
* [smoren - itertools-ts](https://github.com/Smoren/itertools-ts) ⭐ 91 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-18

### Database

* [Typeorm - typeorm](https://github.com/typeorm/typeorm) ⭐ 36,653 | 🐛 640 | 🌐 TypeScript | 📅 2026-09-11
  * [samchon - safe-typeorm](https://github.com/samchon/safe-typeorm) ⚠️ Archived
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 9,216 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-11
* [RobinBuschmann - sequelize-typescript](https://github.com/RobinBuschmann/sequelize-typescript) ⭐ 2,837 | 🐛 264 | 🌐 TypeScript | 📅 2024-04-20

### Server

* [kamilmysliwiec - nest](https://github.com/nestjs/nest) ⭐ 76,642 | 🐛 65 | 🌐 TypeScript | 📅 2026-09-11
  * [samchon - nestia](https://github.com/samchon/nestia) ⭐ 2,177 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 3,004 | 🐛 2 | 🌐 Vue | 📅 2026-09-11 - Streaming Markdown renderer for AI chat interfaces, with Vue, React, Svelte, Angular, and Vue 2 packages plus Mermaid, KaTeX, syntax highlighting, safe HTML, and SSR support.
* [csv-pipe](https://github.com/martsinlabs/csv-pipe) ⭐ 13 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-11
...
* [capcut-cli](https://github.com/renezander030/capcut-cli) ⭐ 451 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-11
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 623 | 🐛 3 | 🌐 Rust | 📅 2026-09-10 - Build agent that uses 80% less token and delivers better results.
...
* [TypeScript Syntax for VIM](https://github.com/leafgarland/typescript-vim) ⭐ 1,896 | 🐛 42 | 🌐 Vim Script | 📅 2025-01-15
* [TypeScript Sublime Plugin](https://github.com/Microsoft/TypeScript-Sublime-Plugin) ⭐ 1,702 | 🐛 161 | 🌐 JavaScript | 📅 2023-03-13
